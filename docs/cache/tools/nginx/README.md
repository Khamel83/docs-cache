...
URL Source: https://nginx.org/en/docs/http/ngx_http_proxy_module.html

Published Time: Tue, 10 Mar 2026 18:06:01 GMT

Markdown Content:
Module ngx_http_proxy_module
===============

 Two projects, similar names, very different futures. [Watch the CNCF webinar: ingress-nginx and NGINX Ingress Controller](https://go.f5.net/cncfwebinar-ingressretirement).

- [x]
[![Image 1: NGINX](https://nginx.org/img/nginx_logo.svg) ![Image 2: NGINX](https://nginx.org/img/nginx_logo_dark.svg)](https://nginx.org/)
==========================================================================================================================================

*   english

*   [русский](https://nginx.org/ru/docs/http/ngx_http_proxy_module.html)
...
[Example Configuration](https://nginx.org/en/docs/http/ngx_http_proxy_module.html#example)

[Directives](https://nginx.org/en/docs/http/ngx_http_proxy_module.html#directives)
...
[proxy_next_upstream_tries](https://nginx.org/en/docs/http/ngx_http_proxy_module.html#proxy_next_upstream_tries)
...
[proxy_socket_keepalive](https://nginx.org/en/docs/http/ngx_http_proxy_module.html#proxy_socket_keepalive)

[proxy_ssl_certificate](https://nginx.org/en/docs/http/ngx_http_proxy_module.html#proxy_ssl_certificate)

[proxy_ssl_certificate_cache](https://nginx.org/en/docs/http/ngx_http_proxy_module.html#proxy_ssl_certificate_cache)

[proxy_ssl_certificate_key](https://nginx.org/en/docs/http/ngx_http_proxy_module.html#proxy_ssl_certificate_key)

[proxy_ssl_ciphers](https://nginx.org/en/docs/http/ngx_http_proxy_module.html#proxy_ssl_ciphers)

[proxy_ssl_conf_command](https://nginx.org/en/docs/http/ngx_http_proxy_module.html#proxy_ssl_conf_command)

[proxy_ssl_crl](https://nginx.org/en/docs/http/ngx_http_proxy_module.html#proxy_ssl_crl)

[proxy_ssl_key_log](https://nginx.org/en/docs/http/ngx_http_proxy_module.html#proxy_ssl_key_log)

[proxy_ssl_name](https://nginx.org/en/docs/http/ngx_http_proxy_module.html#proxy_ssl_name)

[proxy_ssl_password_file](https://nginx.org/en/docs/http/ngx_http_proxy_module.html#proxy_ssl_password_file)

[proxy_ssl_protocols](https://nginx.org/en/docs/http/ngx_http_proxy_module.html#proxy_ssl_protocols)

[proxy_ssl_server_name](https://nginx.org/en/docs/http/ngx_http_proxy_module.html#proxy_ssl_server_name)

[proxy_ssl_session_reuse](https://nginx.org/en/docs/http/ngx_http_proxy_module.html#proxy_ssl_session_reuse)

[proxy_ssl_trusted_certificate](https://nginx.org/en/docs/http/ngx_http_proxy_module.html#proxy_ssl_trusted_certificate)

[proxy_ssl_verify](https://nginx.org/en/docs/http/ngx_http_proxy_module.html#proxy_ssl_verify)

[proxy_ssl_verify_depth](https://nginx.org/en/docs/http/ngx_http_proxy_module.html#proxy_ssl_verify_depth)
...
[Embedded Variables](https://nginx.org/en/docs/http/ngx_http_proxy_module.html#variables)
...
Sets the HTTP protocol version for proxying. By default, version 1.0 is used. Version 1.1 or 2 (1.29.4) is recommended for use with [keepalive](https://nginx.org/en/docs/http/ngx_http_upstream_module.html#keepalive) connections and [NTLM authentication](https://nginx.org/en/docs/http/ngx_http_upstream_module.html#ntlm).

> The version 2 requires the [ngx_http_v2_module](https://nginx.org/en/docs/http/ngx_http_v2_module.html)module.
